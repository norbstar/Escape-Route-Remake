...
{
    public class SneakAction : CrouchAction
    {
        [Range(1f, 5f)]
        ...
        private void EvaluateIntent()
        {
            ...
            execMove = Essentials.IsGrounded() && Essentials.IsCrouching() && Mathf.Abs(moveValue.x) != AbstractedPlayer.MIN_REGISTERED_VALUE;
        }
